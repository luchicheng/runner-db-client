...
Training for running is not only a process of physiology improvments, also a journey full of psychological and philosophical empowerment. `,
        ...
        { name: 'QiFeng Weng (Rico)',
          desc: `As a semi-professional avid runner, I have started training for marathon since July, 2014. 
          I have completed 15 full marathons so far as well as the six World Major Marathons including the prestigious Boston Marathon. 
          Running is not only a way of enjoying the freedom and being with yourself in the nature, but also a beautiful journey of sharing and building friendship with others. 
          I am longing to have more spectacular moments and progress in the future. `,
          nickName: 'Rico',
          src: 'rico.jpg',
